...
def test_all_attributes_present() -> None:
    """195 属性 (personality 42 / speech 134 / archetype 9 / visual 5 / hobby 5)。

    speech 134 = ja 25 + en 5 + archaic_otaku (Phase 8)
    ...
    assert len(names) == 195, f"195 属性あるはずだが {len(names)} 件: {names}"

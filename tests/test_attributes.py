...
- 218 属性 (personality 42 / speech 140 / archetype 14 / visual 5 / hobby 17) 揃っている
...
def test_all_attributes_present() -> None:
    """218 属性 (personality 42 / speech 140 / archetype 14 / visual 5 / hobby 17)。
    ...
    218 属性で v1.5.0 zh/ko speech wave 完了 → 218 属性で v1.8.0 B9 hobby △ 完了。
    218 属性 (personality 42 / speech 140 / archetype 14 / visual 5 / hobby 17)。

...
> **221 reusable character attributes** for AI agent personas —
...
Hersona gives you a typed, schema-validated library of 221 character
...
- **Visual (25)** — silver_hair, glasses, petite, glamorous, animal_ears, twintails, ponytail, heterochromia, tall, kimono, braids, hime_cut, bob_cut, messy_hair, ahoge, blonde, pink_hair, black_hair, red_hair, blue_hair, sharp_eyes, droopy_eyes, jitome, eyepatch, slender, muscular, freckles, tan, mole, scar
...
```bash
hersona list                          # browse all 221 attributes
...
**221 attributes** across 5 categories. The biggest recent expansion is
...
Total breakdown: **personality 42 + speech 140 + archetype 9 + visual 25 + hobby 5 = 221**.
...
[schema/attribute.schema.json](./schema/attribute.schema.json). It currently defines 221 in total:
personality 42 / speech 140 / archetype 9 / visual 25 / hobby 5 (see under [attributes/](./attributes/)).
...
Confirms that all 221 attribute YAMLs validate against the schema.

...
> **224 reusable character attributes** for AI agent personas —
...
Hersona gives you a typed, schema-validated library of 224 character
...
```bash
hersona list                          # browse all 224 attributes
...
**224 attributes** across 5 categories. The biggest recent expansion is
...
Total breakdown: **personality 42 + speech 140 + archetype 32 + visual 5 + hobby 5 = 224**.
...
[schema/attribute.schema.json](./schema/attribute.schema.json). It currently defines 224 in total:
personality 42 / speech 140 / archetype 32 / visual 5 / hobby 5 (see under [attributes/](./attributes/)).
...
Confirms that all 224 attribute YAMLs validate against the schema.

...
> **213 reusable character attributes** for AI agent personas —
...
Hersona gives you a typed, schema-validated library of 213 character
...
```bash
hersona list                          # browse all 213 attributes
...
**213 attributes** across 5 categories. The biggest recent expansion is
...
Total breakdown: **personality 42 + speech 140 + archetype 9 + visual 5 + hobby 17 = 213**.
...
[schema/attribute.schema.json](./schema/attribute.schema.json). It currently defines 213 in total:
personality 42 / speech 140 / archetype 9 / visual 5 / hobby 17 (see under [attributes/](./attributes/)).
...
Confirms that all 213 attribute YAMLs validate against the schema.

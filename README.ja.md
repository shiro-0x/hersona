...
付与する **汎用属性タグのテンプレート集**。現在は personality 34 / speech 30 /
archetype 9 / visual 5 / hobby 5 の計 83 種を定義 (詳細は [attributes/](./attributes/) 配下)。
...
83 属性 YAML が全てスキーマに違反しないことを確認する。

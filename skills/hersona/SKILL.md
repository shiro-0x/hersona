...
There are currently **213 attributes** across 5 categories:
...
```bash
hersona list                                  # full 213-attribute tree
...
**v0.6.0** and documents the v1.6.0 feature set on top of the 213-attribute / speech-140 catalog state.

...
There are currently **224 attributes** across 5 categories:
...
```bash
hersona list                                  # full 224-attribute tree
...
**v0.5.4** and documents the v1.6.0 feature set on top of the 224-attribute / speech-140 catalog state.
